...
case "${1:-} ${2:-}" in
  ...
  'manifest fetch')
    ...
    case "${reference}" in
      ghcr.io/example-org/charts/steward:0.2.5@sha256:cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc)
        digest='sha256:cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc'
        ;;
      ghcr.io/example-org/steward:0.2.5-apiserver@sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa)
        if [[ -n "${platform}" ]]; then
...
cat >"${temporary_directory}/handoff.json" <<'JSON'
{
  ...
  "chart": {
    "reference": "oci://ghcr.io/example-org/charts/steward:0.2.5",
    "digest": "sha256:cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc"
  },
  "images": {
    "apiserver": {
      "reference": "ghcr.io/example-org/steward:0.2.5-apiserver",
      "digest": "sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
    }
  },
  "referenceRuntimes": {
...
cat >"${temporary_directory}/mappings.json" <<'JSON'
{
  ...
  "artifacts": {
    "chart": "registry.example.test/team-a/charts/steward:0.2.5",
    "images.apiserver": "registry.example.test/team-a/steward:0.2.5-apiserver",
...
jq -e '
  ...
  .artifacts.chart.target.reference == "registry.example.test/team-a/charts/steward:0.2.5"
...
jq -e '
  ...
  .chartValues.images.apiserver.tag == "0.2.5-apiserver" and
...
{"schemaVersion":"steward.registry-mappings/v1","artifacts":{"chart":"registry.example.test/team-a/charts/steward:0.2.5"}}
JSON
