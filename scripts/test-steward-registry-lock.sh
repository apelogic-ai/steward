...
case "${1:-} ${2:-}" in
  ...
  'manifest fetch')
    ...
    case "${reference}" in
      ghcr.io/example-org/charts/steward:0.2.6@sha256:cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc)
        digest='sha256:cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc'
        ;;
      ghcr.io/example-org/steward:0.2.6-apiserver@sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa)
        if [[ -n "${platform}" ]]; then
...
cat >"${temporary_directory}/handoff.json" <<'JSON'
{
  ...
  "chart": {
    "reference": "oci://ghcr.io/example-org/charts/steward:0.2.6",
    "digest": "sha256:cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc"
  },
  "images": {
    "apiserver": {
      "reference": "ghcr.io/example-org/steward:0.2.6-apiserver",
      "digest": "sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
    }
  },
  "referenceRuntimes": {
...
jq -e '
  ...
  .artifacts.chart.target.reference == "registry.example.test/team-a/charts/steward:0.2.6"
...
jq -e '
  ...
  .chartValues.images.apiserver.tag == "0.2.6-apiserver" and
...
{"schemaVersion":"steward.registry-mappings/v1","artifacts":{"chart":"registry.example.test/team-a/charts/steward:0.2.6"}}
JSON
