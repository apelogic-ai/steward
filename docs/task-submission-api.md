...
> **Compatibility scope:** This document describes the implemented pre-M1 Task API and
> remains authoritative for Steward v0.1.x. For Steward v0.2.x M1 fields, routes,
> lifecycle, identity claims, and compatibility behavior, the versioned
> [steward.m1/v1 contract](contracts/m1/v1/README.md) is the sole authority. Differences
> here must not be used to reinterpret an M1 request.
