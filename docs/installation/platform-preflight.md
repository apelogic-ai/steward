...
Status: **Supported for Steward v0.2.5**

The release asset `steward-platform-preflight-0.2.5.tar.gz` contains a
...
```sh
tar -xzf steward-platform-preflight-0.2.5.tar.gz
tar -xzf steward-runtime-providers-0.2.5.tar.gz
