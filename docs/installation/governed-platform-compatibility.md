...
Status: **Current release contract for Steward v0.2.6**

The release asset `steward-governed-platform-compatibility-0.2.6.json` is the
...
gh release download v0.2.6 \
  ...
  --pattern steward-governed-platform-compatibility-0.2.6.json \
  --pattern steward-governed-platform-compatibility-0.2.6.json.sha256 \
  --pattern release-handoff.json

sha256sum --check steward-governed-platform-compatibility-0.2.6.json.sha256
gh attestation verify steward-governed-platform-compatibility-0.2.6.json \
  --repo apelogic-ai/steward \
  --cert-identity https://github.com/apelogic-ai/steward/.github/workflows/release.yml@refs/tags/v0.2.6
```
