...
| DP-C01 | `apelogic-ai/steward` | full gate | Corrected contract head `320b79f` is rebased onto merged neutrality maintenance `cc19487`; full `cargo xtask ci` is running. |
| DP-I01 | `github-oidc-exchange` | integration | Native-ARM maintenance merged as `6d4c106`; PR `#31` at `4f7a685` is integrating current `main` without rewriting shared history. |
| DP-G01 | `apelogic-ai/steward` | in progress | Approved dependency boundary; implementation starts from the corrected C01 contract head. |
...
|---|---|---|---|
| DP-C01 | DP-I01, DP-G01, DP-S01, DP-R01, DP-A01 | corrected rebased head `320b79f`; neutrality maintenance merged as `cc19487` | full gate running |
| DP-I01 | DP-S01, DP-O01 | PR `apelogic-ai/github-oidc-exchange#31`, implementation `4f7a685`, contract checkpoint `042e8aa`; native-ARM maintenance merged as `6d4c106` | current-main integration and CI pending |
