...
| DP-C01 | `apelogic-ai/steward` | maintenance review | Corrected contract checkpoint `0455bf3` is focused-green; isolated neutrality maintenance PR `apelogic-ai/steward#82` at `fa921f6` awaits review before the full gate. |
...
|---|---|---|---|
| DP-C01 | DP-I01, DP-G01, DP-S01, DP-R01, DP-A01 | corrected checkpoint `0455bf3`; neutrality maintenance PR `apelogic-ai/steward#82` at `fa921f6` | full gate waits for maintenance merge |
