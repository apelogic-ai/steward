...
| DP-I01 | `github-oidc-exchange` | CI pending | PR `apelogic-ai/github-oidc-exchange#31` at `f9835cd`; local full gates are green. |
...
| DP-A01 | `apelogic-ai/agentic-ops` | CI pending | PR `apelogic-ai/agentic-ops#4` at `5a2930e`; reviewed BOM fix and 95 local tests are green. |
...
| DP-I01 | DP-S01, DP-O01 | PR `apelogic-ai/github-oidc-exchange#31`, commit `f9835cd`, contract checkpoint `042e8aa` | CI and review pending |
...
| DP-A01 | DP-O01 | PR `apelogic-ai/agentic-ops#4`, commit `5a2930e`, closure `steward:sha256:79a68a6e3f7a21d37c4da0594555d409999562b3d1778641f743ec0e290118a8` | CI and review pending |
