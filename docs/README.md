...
| [`installation/installation-guide.md`](installation/installation-guide.md) | **Reference; live acceptance pending** | Prerequisites, installation modes, Secret and integration inventory, post-install checks, and delivery tests. |
